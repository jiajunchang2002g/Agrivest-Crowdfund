...
Hosted on Replit: https://agrivest-crowdfund--jiajunchang2002.replit.app
...
- **Home** — Hero, live platform stats (5 campaigns, 7,990 XRP raised), featured campaign grid, and how-it-works section
- **Explore** — Browse and filter campaigns by status and category, with search
- **Campaign Detail** — Full detail with progress bar, investor list, invest form with XRPL escrow lock, and release/cancel escrow actions with tx hash links to XRPL explorer
...
- Investments lock funds via `EscrowCreate`, released to farmer via `EscrowFinish`, and returned via `EscrowCancel`
